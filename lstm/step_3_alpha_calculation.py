...
def main():
    ...
    # Plot example of the predicted trajectories.
    # example_index = 10
    # step_2_predictor_training.plot_predictions_2d(training_trajectories[example_index], predicted_trajectories[example_index], "Example Prediction from LSTM", "")
