...
def main():
    ...
    predicted_trajectories = step_2_predictor_training.generate_pred_trajectories(trained_transformer_models, trajectories, transformer_norm)
    predicted_shifted_trajectories = step_2_predictor_training.generate_pred_trajectories(trained_transformer_models, shifted_trajectories, transformer_norm)
